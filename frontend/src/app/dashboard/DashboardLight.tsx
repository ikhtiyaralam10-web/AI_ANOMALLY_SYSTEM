      ...
      <main className="ml-[15%] flex-grow flex h-screen pt-16 pb-4 px-4 gap-1">
        ...
        <div className="flex-[55%] flex flex-col gap-1">
          ...
          <div className="flex gap-1 h-[25%]">
            <div className="glass-panel flex-1 rounded-xl p-6 flex flex-col items-center justify-center relative bg-surface-container overflow-hidden" style={{ background: "#ffffff", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", border: "1px solid #dee3e4" }}>
            ...
            <div className="glass-panel flex-1 rounded-xl p-6 flex flex-col items-center justify-center relative shadow-[inset_0_0_10px_rgba(186,26,26,0.05)] overflow-hidden border-error/50" style={{ background: "#ffffff", boxShadow: "inset 0 0 10px rgba(186,26,26,0.05)", border: "1px solid rgba(186,26,26,0.5)" }}>
          ...
          <div className="grid grid-cols-3 gap-1 h-[22%]">
            <div className="glass-panel rounded-xl p-4 flex flex-col justify-between" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
              <div className="flex justify-between items-start">
                <span className="font-mono text-[11px] font-bold text-on-surface-variant uppercase">Vibration RMS</span>
                <span className="px-2 py-1 bg-error text-on-error font-mono text-xs rounded">CRIT</span>
              </div>
              <div>
                ...
                <div className="h-8 mt-2 w-full bg-surface-container rounded relative overflow-hidden">
                  ...
                  <svg className="w-full h-full" preserveAspectRatio="none">
                    <path d="M0,30 Q10,10 20,20 T40,25 T60,5 T80,15 T100,0 L100,32 L0,32 Z" fill="rgba(186,26,26,0.1)" stroke="#ba1a1a" strokeWidth="2"></path>
                  </svg>
                </div>
              </div>
            </div>
            <div className="glass-panel rounded-xl p-4 flex flex-col justify-between" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
              <div className="flex justify-between items-start">
                ...
                <span className="px-2 py-1 bg-secondary text-on-secondary font-mono text-xs rounded">WARN</span>
              </div>
              <div>
                ...
                <div className="h-8 mt-2 w-full bg-surface-container rounded relative overflow-hidden">
                  <svg className="w-full h-full" preserveAspectRatio="none">
                    <path d="M0,20 Q15,15 30,25 T60,10 T90,20 T100,15 L100,32 L0,32 Z" fill="rgba(126,87,0,0.1)" stroke="#7e5700" strokeWidth="2"></path>
                  </svg>
                </div>
              </div>
            </div>
            <div className="glass-panel rounded-xl p-4 flex flex-col justify-between" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
              <div className="flex justify-between items-start">
                ...
                <span className="px-2 py-1 bg-primary text-on-primary font-mono text-xs rounded">NOM</span>
              </div>
              <div>
                ...
                <div className="h-8 mt-2 w-full bg-surface-container rounded relative overflow-hidden">
                  <svg className="w-full h-full" preserveAspectRatio="none">
                    <path d="M0,25 Q20,25 40,25 T80,25 T100,25 L100,32 L0,32 Z" fill="rgba(0,105,112,0.1)" stroke="#006970" strokeWidth="2"></path>
                  </svg>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-1 h-[18%]">
            ...
            <div className="glass-panel rounded-xl p-4 flex flex-col justify-between" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
              ...
              <div>
                ...
                <div className="h-8 mt-2 w-full bg-surface-container rounded relative overflow-hidden">
                  <svg className="w-full h-full" preserveAspectRatio="none">
                    <path d="M0,25 Q15,20 30,25 T60,22 T90,25 T100,24 L100,32 L0,32 Z" fill="rgba(0,105,112,0.1)" stroke="#006970" strokeWidth="2"></path>
                  </svg>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel rounded-xl p-4 flex flex-col justify-between" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
              ...
              <div>
                ...
                <div className="h-8 mt-2 w-full bg-surface-container rounded relative overflow-hidden">
                  <svg className="w-full h-full" preserveAspectRatio="none">
                    <path d="M0,28 Q20,15 40,22 T70,18 T100,25 L100,32 L0,32 Z" fill="rgba(126,87,0,0.1)" stroke="#7e5700" strokeWidth="2"></path>
                  </svg>
                </div>
              </div>
            </div>
            {/* Container 6: SYSTEM OVERRIDE / SIMULATION */}
            <div className="glass-panel rounded-xl p-4 flex flex-col" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
          ...
          {/* Historical Chart */}
          <div className="glass-panel flex-grow rounded-xl p-6 flex flex-col" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
            ...
            <div className="flex-grow relative bg-surface-container rounded border border-outline-variant overflow-hidden">
              ...
              <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                <path className="drop-shadow-[0_0_3px_rgba(0,105,112,0.3)]" d="M0,70 Q10,75 20,65 T40,60 T60,70 T70,20 T80,10 T90,50 T100,55" fill="none" stroke="#006970" strokeWidth="3"></path>
                <path className="drop-shadow-[0_0_5px_rgba(186,26,26,0.5)]" d="M70,20 T80,10" fill="none" stroke="#ba1a1a" strokeWidth="4"></path>
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="flex-[30%] flex flex-col gap-1">
          {/* RCA Narrative */}
          <div className="glass-panel flex-[40%] rounded-xl p-6 border-l-4 border-l-secondary" style={{ background: "#ffffff", border: "1px solid #dee3e4", borderLeftColor: "var(--theme-secondary)" }}>
          ...
          {/* Recommended Action */}
          <div className="glass-panel flex-[25%] rounded-xl p-6 bg-error-container/50 border border-error/50 flex flex-col justify-center" style={{ background: "rgba(255, 218, 214, 0.5)", border: "1px solid rgba(186, 26, 26, 0.5)" }}>
          ...
          {/* Simulation Lab */}
          <div className="glass-panel flex-[35%] rounded-xl p-6" style={{ background: "#ffffff", border: "1px solid #dee3e4" }}>
            ...
            <div className="space-y-6 mt-4">
              <div>
                ...
                <input className="w-full accent-primary h-1 bg-surface-container rounded appearance-none focus:outline-none" max="20" min="0" type="range" defaultValue="14.2" />
              </div>
              <div>
                <div className="flex justify-between font-mono text-xs mb-2">
                ...
                <input className="w-full accent-secondary h-1 bg-surface-container rounded appearance-none focus:outline-none" max="150" min="0" type="range" defaultValue="88.5" />
              </div>
            </div>
          </div>
        </div>
