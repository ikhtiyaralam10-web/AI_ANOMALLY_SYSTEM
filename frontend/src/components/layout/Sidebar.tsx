  ...
  return (
    <div className="w-64 h-full bg-[rgba(255,255,255,0.03)] backdrop-blur-[12px] border-r border-[rgba(255,255,255,0.08)] flex flex-col p-4 z-10 relative">
      ...
      <nav className="flex-1 space-y-2">
        <a href="#" className="flex items-center gap-3 px-3 py-2 rounded-[var(--radius-md)] bg-[rgba(0,240,255,0.1)] text-[var(--color-primary-container)] border border-[rgba(0,240,255,0.2)] transition-colors">
      ...
      <div className="mt-auto pt-4 border-t border-[rgba(255,255,255,0.08)]">
        <div className="flex items-center gap-3 px-3 py-2">
          <div className="w-2 h-2 rounded-full bg-[var(--color-primary-container)] animate-pulse shadow-[0_0_8px_var(--color-primary-container)]"></div>
          <span className="text-sm font-medium text-[var(--color-on-surface)]">System: Online</span>
        </div>
      </div>
    </div>
  );
